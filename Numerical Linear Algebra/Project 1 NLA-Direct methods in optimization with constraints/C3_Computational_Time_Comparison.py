...
plot1.plot(n_list,compt_time_list_with_LU,'red')
plot1.set_title('Computational time')
plot1.set_ylabel('Total time (milisec.)')
plot1.set_xlabel('Value of n')
plot1.legend(('Computational Time','Computational Time with LU'))
plt.show()
fig1.savefig('Computational_Time_Comparison.jpeg')